...
const knownMessages: Record<string, string> = {
  ...
  invalid_material_product: "Selecciona cada producto aplicado desde el catálogo antes de guardar.",
  ambiguous_material_product: "Hay varios productos con ese nombre. Selecciona el producto correcto del catálogo.",
  invalid_work_material: "Los productos de esta actividad cambiaron. Cierra el formulario y vuelve a abrirlo.",
  duplicate_work_material: "Un producto aparece repetido en el registro. Revisa los productos aplicados.",
  work_materials_required: "Agrega al menos un producto aplicado.",
  work_material_product_required: "Selecciona el producto aplicado desde el catálogo.",
  work_material_dose_required: "Indica la dosis y la unidad de cada producto aplicado.",
  work_is_closed: "Esta actividad ya está cerrada. Actualiza la página para consultar su registro.",
  ...
  grok_not_configured: "Grok todavía no está configurado. Guarda la URL y las claves de la rutina en Supabase.",
  grok_dispatch_failed: "No se pudieron entregar las actividades a Grok.",
  grok_callback_failed: "Mira recibió la respuesta de Grok, pero no pudo registrar el cambio.",
  agent_dispatch_not_found: "No encontramos el envío de Grok relacionado con esta actividad.",
  agent_callback_id_required: "La respuesta de Grok necesita un identificador único.",
  invalid_agent_callback_status: "Grok envió un estado que Mira no reconoce.",
  irrigation_actuals_required: "Confirma duración y litros reales antes de completar el riego.",
  nutrition_method_required: "Confirma el método aplicado antes de completar la nutrición.",
  harvest_kilograms_required: "Confirma los kilogramos antes de completar la cosecha.",
