...
const knownMessages: Record<string, string> = {
  ...
  invalid_work_transition: "Ese trabajo no puede pasar a ese estado.",
  invalid_work_payload: "Los datos de ejecución del trabajo no son válidos.",
  invalid_work_occurred_at: "La fecha real del trabajo no es válida.",
