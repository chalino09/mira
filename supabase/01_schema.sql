...
create table if not exists public.harvest_records (
  ...
  box_count numeric(12,2) not null default 0,
  ...
  third_quality_kg numeric(12,2) not null default 0,
  discard_kg numeric(12,2) not null default 0,
  merma_kg numeric(12,2) not null default 0,
  first_quality_boxes numeric(12,2) not null default 0,
  second_quality_boxes numeric(12,2) not null default 0,
  third_quality_boxes numeric(12,2) not null default 0,
  merma_boxes numeric(12,2) not null default 0,
  first_quality_price numeric(12,2) not null default 0,
  second_quality_price numeric(12,2) not null default 0,
  third_quality_price numeric(12,2) not null default 0,
