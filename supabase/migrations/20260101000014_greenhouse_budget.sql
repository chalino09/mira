-- mira - 14 Greenhouse budget
-- Ejecutar después de 13_greenhouse_manager_scope.sql.
-- Presupuesto opcional por invernadero/ciclo para comparar contra costos reales.
...
do $$ begin
  alter table public.greenhouses
  add constraint greenhouses_budget_amount_check
