-- Corrige la ejecución de trabajos de aplicación desde Telegram.
-- `products.category` es un enum; se convierte a texto antes de combinarlo
-- con la categoría opcional recibida en el payload.
